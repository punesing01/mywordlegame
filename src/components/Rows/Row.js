...
const Row = props => {
    ...
    return(
        <div className='gridrow'>
            <Cell value={props.answer? props.answer[0]:null} color={props.color? props.color[0]:props.rowColor.first}/>
            <Cell value={props.answer? props.answer[1]:null} color={props.color? props.color[1]:props.rowColor.second}/>
